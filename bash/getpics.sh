...
(wget -q -O ~/public_html/pics/pics.zip http://zonzorp.net/pics.zip && wget -q -O ~/public_html/pics/pics.tgz http://zonzorp.net/pics.tgz) && (unzip -d ~/public_html/pics -o -q ~/public_html/pics/pics.zip && tar -xf ~/public_html/pics/pics.tgz -C ~/public_html/pics) && (rm ~/public_html/pics/pics.zip && rm ~/public_html/pics/pics.tgz)
